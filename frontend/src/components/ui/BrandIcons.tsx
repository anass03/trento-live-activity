/* Icone brand condivise (login social, bottoni calendario). */

export function GoogleBrandIcon({ size = 16 }: { size?: number }) {
  return (
...
export function AppleBrandIcon({ size = 15 }: { size?: number }) {
  return (
