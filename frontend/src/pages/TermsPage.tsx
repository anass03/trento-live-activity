  ...
  return (
    <section className="data-page legal-page">
      ...
      <article className="liquid-card legal-content">
        ...
        <p>
          These terms govern the use of the <strong>Trento Live Activity</strong> platform,
          a civic service promoted by the Municipality of Trento for consulting real-time urban
          data and for creating and participating in spontaneous social activities.
        </p>
        <h2>2. Account</h2>
        <ul>
          <li>Registration is free and restricted to persons aged at least 13.</li>
          <li>The user is responsible for safeguarding their credentials and for all activity carried out through their account.</li>
          <li>System administrators are required to enable two-factor authentication (RNF15).</li>
        </ul>
        <h2>3. Spontaneous activities</h2>
        <p>
          Activities created by citizens use predefined values only (category, type) and do not
          allow free text (RNF22). The number of participants must be between 2 and 50 (OCL C8)
          and the start date cannot be in the past (OCL C9).
        </p>
        <h2>4. Certified events</h2>
        <p>
          Events published by certified entities may contain free text and are marked with a
          verification badge. They are subject to moderation as required by the Digital Services
          Act (EU Regulation 2022/2065).
        </p>
        <h2>5. User conduct</h2>
        <p>
          It is prohibited to publish unlawful, offensive, discriminatory content or content that
          violates the rights of third parties. It is prohibited to impersonate other individuals
          or organisations. The platform reserves the right to remove content and suspend accounts
          in the event of violations.
        </p>
        <h2>6. Reports</h2>
        <p>
          Any user may report content they consider inappropriate. A maximum of one report per
          user per event is allowed (OCL C22). Reports are handled according to the DSA-compliant
          moderation workflow.
        </p>
        <h2>7. Limitation of liability</h2>
        <p>
          The platform provides information for informational purposes only and does not guarantee
          the perfect accuracy of real-time IoT data. Social activities are organised between
          citizens under their sole responsibility.
        </p>
        <h2>8. Changes</h2>
        <p>
          These terms may be updated. Material changes require new explicit consent from the user.
        </p>
        <h2>9. Jurisdiction</h2>
        <p>
          The Court of Trento shall have jurisdiction over any dispute.
        </p>
      </article>
    </section>
  );
