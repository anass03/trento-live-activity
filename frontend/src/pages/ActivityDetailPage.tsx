...
import { getActivityById, getActivityCalendarUrl, getToken, joinActivity, leaveActivity, type ApiActivity } from '../lib/api';
    ...
    <section className="detail-page glass-panel">
      ...
      {!isLoading && !error && activity && (
        <>
          ...
          {activity.dateTime && (
            <a href={getActivityCalendarUrl(activity.id)} download={`attivita-${activity.id}.ics`} className="primary-button" style={{ width: 'fit-content' }}>📅 Aggiungi al calendario</a>
          )}
