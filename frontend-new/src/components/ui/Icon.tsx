...
export const Icon = ({ name, size, style, className }: IconProps) => {
  ...
  const P: Record<string, JSX.Element> = {
    ...
    key:      <><circle cx="7.5" cy="14.5" r="3.5" /><path d="M11 14.5h9" /><path d="M17 14.5v-3" /><path d="M14.5 14.5v2.5" /></>,
    logIn:    <><path d="M15 3.5h3.5A2.5 2.5 0 0 1 21 6v12a2.5 2.5 0 0 1-2.5 2.5H15" /><path d="M10 17l5-5-5-5" /><path d="M15 12H3" /></>,
    logOut:   <><path d="M9 3.5H5.5A2.5 2.5 0 0 0 3 6v12a2.5 2.5 0 0 0 2.5 2.5H9" /><path d="M14 17l5-5-5-5" /><path d="M19 12H8" /></>,
    ...
    globe:    <><circle cx="12" cy="12" r="9" /><path d="M3.6 9h16.8" /><path d="M3.6 15h16.8" /><path d="M12 3a14 14 0 0 1 0 18" /><path d="M12 3a14 14 0 0 0 0 18" /></>,
...
export const WxIcon = ({ className }: { className?: string }) => (
